 ...
 * Über den Namen des Attributes kann auf den Inhalt zugegriffen werden.
 * 
...
class AttributesOfInterface {
  ...
  /**
   * Liefert den Wert anhand des übergebenen Schlüssels.<p>
  ...
  /**
   * Fügt der {@link HashMap} eine Eigenschaft hinzu oder überschreibt diese.<p>
